...
if exist webMAN_MOD_1.46.xx_Updater.pkg del webMAN_MOD_1.46.xx_Updater.pkg>>nul
...
if exist webMAN_MOD_1.46.xx_Updater.pkg del webMAN_MOD_1.46.xx_Updater.pkg>>nul
move /y EP0001-UPDWEBMOD_00-0000000000000000.pkg webMAN_MOD_1.46.xx_Updater.pkg>>nul
