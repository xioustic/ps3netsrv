...
static void detect_firmware(void)
{
 ...
 #ifndef LAST_FIRMWARE_ONLY
		if(peekq(0x800000000030F2D0ULL) == DEX) {SYSCALL_TABLE = SYSCALL_TABLE_475D; c_firmware = (peekq(0x800000000031EF48ULL) == 0x323031362F31302FULL) ? 4.81f : (peekq(0x800000000031EF48ULL) == 0x323031352F31322FULL) ? 4.78f : (peekq(0x800000000031EF48ULL) == 0x323031352F30382FULL) ? 4.76f : 4.75f; dex_mode = 2;}	else
...
static void poke_patches(u64 addr_3C, u64 addr_3D, u64 addr_3E,
...
static void new_poke_patches(u64 addr_3C, u64 addr_3D, u64 addr_3E,
							 u64 addr_jump, u64 addr_09,
							 u64 addr_lic, u64 addr_17,
							 u64 addr_restore1, u64 addr_restore2)
{
	//patches by deank
	poke_patches(addr_3C, addr_3D, addr_3E, addr_jump, addr_09);
...
static void patch_lv2(void)
{
	...
	{ // CEX
		...
		if(c_firmware == 3.55f)
		{
			poke_patches(0x80000000002909B0ULL, 0x8000000000055EA0ULL, 0x8000000000055F64ULL,
		...
		if(c_firmware == 4.21f)
		{
			poke_patches(0x8000000000296264ULL, 0x8000000000057020ULL, 0x80000000000570E4ULL,
		...
		if(c_firmware == 4.30f)
		{
			...
			poke_patches(0x80000000002979D8ULL, 0x8000000000057170ULL, 0x8000000000057234ULL,
		...
		if(c_firmware == 4.31f)
		{
			poke_patches(0x80000000002979E0ULL, 0x8000000000057174ULL, 0x800000000005723CULL,
		...
		if(c_firmware == 4.40f)
		{
			poke_patches(0x8000000000296DE8ULL, 0x80000000000560BCULL, 0x8000000000056180ULL,
		...
		if(c_firmware == 4.41f)
		{
			poke_patches(0x8000000000296DF0ULL, 0x80000000000560C0ULL, 0x8000000000056184ULL,
		...
		if(c_firmware == 4.46f)
		{
			poke_patches(0x8000000000297310ULL, 0x80000000000560C0ULL, 0x8000000000056184ULL,
						 0x8000000000056130ULL, 0x8000000000059AF4ULL);
 #ifndef COBRA_ONLY
			sc_600 = 0x33DD40;
			sc_604 = 0x33DEA8;
		...
		if(c_firmware == 4.50f)
		{
			poke_patches(0x800000000026F61CULL, 0x80000000000560BCULL, 0x8000000000056180ULL,
						 0x800000000005612CULL, 0x8000000000059AF0ULL);
 #ifndef COBRA_ONLY
			sc_600 = 0x33C180;
			sc_604 = 0x33C2E8;
		...
		if(c_firmware == 4.53f)
		{
			poke_patches(0x800000000026F7F0ULL, 0x80000000000560C0ULL, 0x8000000000056184ULL,
						 0x8000000000056130ULL, 0x8000000000059AF4ULL);
 #ifndef COBRA_ONLY
			sc_600 = 0x33C308;
			sc_604 = 0x33C470;
		...
		if(c_firmware == 4.55f)
		{
			poke_patches(0x800000000027103CULL, 0x8000000000056380ULL, 0x8000000000056444ULL,
		...
		if(c_firmware == 4.60f)
		{
			new_poke_patches(0x800000000026FDD4ULL, 0x8000000000056588ULL, 0x800000000005664CULL,
			...
			//poke_patches(0x80000000002925D8ULL, 0x8000000000056588ULL, 0x800000000005664CULL,
			//			 0x80000000000565F8ULL, 0x800000000005A654ULL,
			//			 0, 0, 0, 0);
/*
...
*/
		...
		if(c_firmware == 4.65f || c_firmware == 4.66f)
		{
			new_poke_patches(0x800000000026FDDCULL, 0x800000000005658CULL, 0x8000000000056650ULL,
		...
		if(c_firmware == 4.70f)
		{
			new_poke_patches(0x80000000002670D8ULL, 0x8000000000056588ULL, 0x800000000005664CULL,
		...
		if(c_firmware == 4.80f)
		{
			new_poke_patches(0x8000000000267144ULL, 0x800000000005688CULL, 0x800000000005664CULL,
		...
		if(c_firmware >= 4.75f && c_firmware <= 4.81f)
		{
			new_poke_patches(0x800000000026714CULL, 0x800000000005658CULL, 0x8000000000056650ULL,
	...
	{ // DEH
		if(c_firmware == 3.55f)
		{
			poke_patches(0x8000000000291794ULL, 0x8000000000059C58ULL, 0x8000000000059D1CULL,
...
/*
		if(c_firmware == 4.50f)
		{
			poke_patches(0x8000000000276A00ULL, 0x8000000000059E74ULL, 0x8000000000059F38ULL,
...
*/
		if(c_firmware == 4.60f)
		{
			new_poke_patches(0x80000000002771B8ULL, 0x800000000005A340ULL, 0x800000000005A404ULL,
		...
		if(c_firmware == 4.80f)
		{
			new_poke_patches(0x800000000026E528ULL, 0x800000000005A340ULL, 0x800000000005A020ULL,
		...
		if(c_firmware >= 4.75f && c_firmware <= 4.81f)
		{
			new_poke_patches(0x800000000026E530ULL, (c_firmware == 4.81f) ? 0x800000000005A584ULL : 0x800000000005A344ULL, 0x800000000005A408ULL,
	...
	{ // DEX
		...
		if(c_firmware == 3.55f)
		{
			poke_patches(0x8000000000298790ULL, 0x800000000005978CULL, 0x8000000000059850ULL,
		...
		if(c_firmware == 4.21f)
		{
			poke_patches(0x800000000029C8C0ULL, 0x800000000005A938ULL, 0x800000000005A9FCULL,
		...
		if(c_firmware == 4.30f)
		{
			poke_patches(0x800000000029E034ULL, 0x800000000005AA88ULL, 0x800000000005AB4CULL,
		...
		if(c_firmware == 4.31f)
		{
			poke_patches(0x800000000029E03CULL, 0x800000000005AA8CULL, 0x800000000005AB50ULL,
		...
		if(c_firmware == 4.40f)
		{
			poke_patches(0x800000000029D444ULL, 0x80000000000599D4ULL, 0x8000000000059A98ULL,
		...
		if(c_firmware == 4.41f)
		{
			poke_patches(0x800000000029D44CULL, 0x80000000000599D8ULL, 0x8000000000059A9CULL,
		...
		if(c_firmware == 4.46f)
		{
			poke_patches(0x800000000029D96CULL, 0x80000000000599D8ULL, 0x8000000000059A9CULL,
						 0x8000000000059A48ULL, 0x800000000005D40CULL);
  #ifndef COBRA_ONLY
			sc_600 = 0x35B150;
			sc_604 = 0x35B228;
		...
		if(c_firmware == 4.50f)
		{
			poke_patches(0x8000000000275D38ULL, 0x8000000000059A8CULL, 0x8000000000059B50ULL,
		...
		if(c_firmware == 4.53f)
		{
			poke_patches(0x8000000000275F0CULL, 0x8000000000059A90ULL, 0x8000000000059B54ULL,
		...
		if(c_firmware == 4.55f)
		{
			poke_patches(0x8000000000277758ULL, 0x8000000000059D50ULL, 0x8000000000059E14ULL,
		...
		if(c_firmware == 4.60f)
		{
			new_poke_patches(0x80000000002764F0ULL, 0x8000000000059F58ULL, 0x800000000005A01CULL,
		...
		if(c_firmware == 4.65f || c_firmware == 4.66f)
		{
			new_poke_patches(0x80000000002764F8ULL, 0x8000000000059F5CULL, 0x800000000005A020ULL,
		...
		if(c_firmware == 4.70f)
		{
			new_poke_patches(0x800000000026D7F4ULL, 0x8000000000059F58ULL, 0x800000000005A01CULL,
		...
		if(c_firmware == 4.80f)
		{
			new_poke_patches(0x800000000026D860ULL, 0x8000000000059F58ULL, 0x800000000005A01CULL,
							 0x8000000000059FC8ULL, 0x800000000005E0ACULL,
							 0x8000000000059BFCULL, 0x800000000022DAC8ULL,
							 0x8000000000059628ULL, 0x800000000005C7E8ULL);
#ifndef COBRA_ONLY
		...
		if(c_firmware >= 4.75f && c_firmware <= 4.81f)
		{
			new_poke_patches(0x800000000026D868ULL, 0x8000000000059F5CULL, 0x800000000005A020ULL,
